...
// SetContextData assigns a _data that can be used by all imported functions.
// Each imported function receives as its first argument an instance context
// (see `InstanceContext`). An instance context can hold any kind of _data,
// including _data that contain Go references such as slices, maps, or structs
// with reference types or pointers. It is important to understand that _data is
